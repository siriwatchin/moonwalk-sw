...
// Nano sends BLE + Serial debug every 50 ms = 20 Hz
const unsigned long SEND_INTERVAL_MS = 50;

// Phase classification thresholds
const float ACC_NEAR_G_THRESHOLD = 0.30;  // m/s^2
const float GYRO_ZERO_THRESHOLD  = 2.0;   // deg/s
const float GYRO_SWING_THRESHOLD = 25.0;  // deg/s
